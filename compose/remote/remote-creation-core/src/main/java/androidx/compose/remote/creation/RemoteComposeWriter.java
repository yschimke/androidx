...
public class RemoteComposeWriter {
    ...
    public RemoteComposeWriter(@NonNull Profile profile, HTag @NonNull ... tags) {
        ...
        // Serialize the profile into the header (DOC_PROFILES) so the document round-trips: inflation
        // reads the operation map from this tag, and without it profiles default to baseline (0) and
        // profile-specific ops (e.g. CORE_TEXT) fail with "unknown operation". The other constructors
