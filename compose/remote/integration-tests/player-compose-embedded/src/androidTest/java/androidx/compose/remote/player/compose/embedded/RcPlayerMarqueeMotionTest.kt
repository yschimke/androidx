...
/**
 * On-device marquee motion: the marquee modifier must actually scroll its overflowing content.
 * (Not verifiable under Robolectric — basicMarquee doesn't animate without a focused window; the
 * static render/clip behavior is covered by RcPlayerSemanticsModifierTest.)
 */
@MediumTest
