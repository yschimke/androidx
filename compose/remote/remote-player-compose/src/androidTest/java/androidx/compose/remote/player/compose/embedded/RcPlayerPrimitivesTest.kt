...
class RcPlayerPrimitivesTest {
    ...
    @Test
    @org.junit.Ignore("Fails with first frame issue: componentWidth() returns 0 initially")
                                    ...
                                    RemoteModifier.clickable(
                                        action =
                                            androidx.compose.remote.creation.compose.action
                                                .ValueChange(parentSize, 200f.rf)
                                    )
                            ) {
                                RemoteText("Change")
                            }
    ...
    @Test
    @org.junit.Ignore("Causes infinite recomposition loop")
    @OptIn(androidx.compose.remote.creation.compose.ExperimentalRemoteCreationComposeApi::class)
    ...
    @Test
    @org.junit.Ignore("Fails with unexpected offset values: shift is smaller than expected")
    ...
    @Test
    @org.junit.Ignore("Causes infinite recomposition loop due to writes during composition")
    fun testDrawCircle() {
        rule.setContent {
            val document = rememberRemoteDocument {
                RemoteBox {
