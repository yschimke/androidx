...
) = RemoteContentPreview(playerImpl = playerImpl) { Container { RemoteTextButtonEnabled() } }
...
private fun RemoteTextButtonTonalPreview(
    @PreviewParameter(PlayerImplPreviewParameterProvider::class) playerImpl: PlayerImpl
) = RemoteContentPreview(playerImpl = playerImpl) { Container { RemoteTextButtonTonal() } }
...
private fun RemoteTextButtonOutlinePreview(
    @PreviewParameter(PlayerImplPreviewParameterProvider::class) playerImpl: PlayerImpl
) = RemoteContentPreview(playerImpl = playerImpl) { Container { RemoteTextButtonOutline() } }
