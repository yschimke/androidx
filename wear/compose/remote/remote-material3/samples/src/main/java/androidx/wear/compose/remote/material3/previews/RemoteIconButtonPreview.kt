...
) = RemoteContentPreview(playerImpl = playerImpl) { Container { RemoteIconButtonEnabled() } }
...
private fun RemoteIconButtonTonalPreview(
    @PreviewParameter(PlayerImplPreviewParameterProvider::class) playerImpl: PlayerImpl
) = RemoteContentPreview(playerImpl = playerImpl) { Container { RemoteIconButtonTonal() } }
...
private fun RemoteIconButtonOutlinedPreview(
    @PreviewParameter(PlayerImplPreviewParameterProvider::class) playerImpl: PlayerImpl
) = RemoteContentPreview(playerImpl = playerImpl) { Container { RemoteIconButtonOutlined() } }
